...
export default function PodcastsScreen({ navigation }: RootTabScreenProps<'Videos'>) {
	return (
			...
			<ScrollView>
				...
				>
					...
					<View style={styles.inline}>
						...
						<Text style={styles.title} numberOfLines={2}>Comi o cu de quem ta lendo</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/EoAiibbXEAgWDgS.jpg')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Pinto Médio Cast</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/aaaa.png')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Velho Broxa Cast</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
