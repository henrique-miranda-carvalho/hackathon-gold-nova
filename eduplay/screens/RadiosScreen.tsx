...
export default function RadiosScreen({ navigation }: RootTabScreenProps<'Videos'>) {
	return (
			...
			<ScrollView>
				...
				>
					...
					<View style={styles.inline}>
						...
						<Text style={styles.title} numberOfLines={2}>O tiozinho e o tiozão</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/43415.v3.png')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Radio Gospel Campinas</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/xIQOSwFr_400x400.jpg')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Trosoba FM</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
