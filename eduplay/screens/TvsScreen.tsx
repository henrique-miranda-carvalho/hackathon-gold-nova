			...
			<ScrollView>
				...
				>
					...
					<View style={styles.inline}>
						...
						<Text style={styles.title} numberOfLines={2}>Datena</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/590081-5bbabdc45e614_sargento.jpg')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Sargento Fahur prende o maior fumante do mundo</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
				...
				>
					<Image
						style={styles.cardImage}
						source={require('../assets/images/15883482385eac454ed79d7_1588348238_16x9_md.jpg')}
					/>
					<View style={styles.separatorFromVideo} lightColor="#eee" darkColor="rgba(255,255,255,0.1)" />
					<View style={styles.inline}>
						<Pressable
						...
						<Text style={styles.title} numberOfLines={2}>Jornal Nacional</Text>
						<View style={styles.inlineInside}>
							<Text style={styles.subtitles}>Você Sabia?</Text>
							<Text style={styles.continuity}>•</Text>
